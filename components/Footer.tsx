...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-16 font-helvetica-neue">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm px-6">
        {/* Follow Us */}
        <div>
          <h3 className="text-gray-400 font-medium mb-3">Follow Us</h3>
          <p>Instagram</p>
          <p>PPT Credential</p>
        </div>
        ...
        {/* Contact */}
        <div>
          <h3 className="text-gray-400 font-medium mb-3">Contact</h3>
        ...
        {/* Office */}
        <div>
          <h3 className="text-gray-400 font-medium mb-3">Office</h3>
        ...
        {/* Credits */}
        <div>
          <h3 className="text-gray-400 font-medium mb-3">Credits</h3>
